...
namespace arcade
{
  ...
  private:
    ...
    static t_bunny_response _lostFocusHandler(t_bunny_window const *win,
                                              void *                data);
    static t_bunny_response _gotFocusHandler(t_bunny_window const *win,
                                             void *                data);
    static t_bunny_response _resizeHandler(t_bunny_window const *  win,
                                           t_bunny_position const *size,
                                           void *                  data);
    static t_bunny_response _closeHandler(t_bunny_window const *win,
                                          void *                data);
